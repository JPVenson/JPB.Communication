...
namespace JPB.Communication.WinRT.combase
{
    ...
    public abstract class NetworkReceiverBase : Networkbase, INetworkReceiver
    {
        protected NetworkReceiverBase()
        {
            ...
            _pendingrequests = new List<Tuple<Action<RequestMessage>, Guid>>();
            _requestHandler = new List<Tuple<Func<RequestMessage, object>, object>>();
        ...
        public void RegisterRequstHandler(Func<RequestMessage, object> action, object state)
        {
            _requestHandler.Add(new Tuple<Func<RequestMessage, object>, object>(action, state));
        }
        ...
        /// </summary>
        /// <param name="action"></param>
        public void UnRegisterRequstHandler(Func<RequestMessage, object> action, object state)
        {
        ...
        /// </summary>
        /// <param name="action"></param>
        public void UnRegisterRequstHandler(Func<RequestMessage, object> action)
        {
        ...
        internal void RegisterRequst(Action<RequestMessage> action, Guid guid)
        {
            _pendingrequests.Add(new Tuple<Action<RequestMessage>, Guid>(action, guid));
        }
        ...
        protected readonly List<Tuple<Action<RequestMessage>, Guid>> _pendingrequests;
        protected readonly List<Tuple<Func<RequestMessage, object>, object>> _requestHandler;
