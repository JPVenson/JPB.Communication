...
namespace JPB.Communication.WPF.Controls.ViewModel
{
    public class NetworkLogViewModel : AsyncViewModelBase
    {
        ...
        void Networkbase_OnNewItemLoadedSuccess(object mess, ushort port, MessageBaseInfo info)
        {
            TcpNetworkActionLog.Add(new TcpNetworkAction(TcpNetworkActionType.LoadSuccess, new { Port = port, Message = mess, Info = info }));
        }
        ...
        void Networkbase_OnMessageSend(object mess, ushort port, MessageBaseInfo info)
        {
            TcpNetworkActionLog.Add(new TcpNetworkAction(TcpNetworkActionType.Send, new { Port = port, Message = mess, Info = info }));
        }
